...
minstr = .true.
    ...
    call ScreenSurface(na,iza,xa,cell,surface,fakebmx)
    call MetalBond(na,iza,xa,cell,surface,fakebmx)
    call get_conn(na,iza,xa,conn,cell)
!write(*,*)  'connbmx finish'
...
subroutine ScreenSurface(na,iza,xa,cell,surface,fakebmx)
implicit none
double precision :: totbond,dist,co1,co2
integer   ::  na,i,j
integer   ::  iza(na),surface(na),fakebmx(na,na)
double precision  :: cell(3,3),xa(3,na)
!logical  :: surface
...
subroutine MetalBond(na,iza,xa,cell,surface,fakebmx)
implicit none
double precision :: totbond,dist,co1,co2
integer   ::  na,i,j
integer   ::  iza(na),surface(na),fakebmx(na,na)
