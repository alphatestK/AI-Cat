...
#        return
    ...
    def GenName0(self,ISECFP,FSECFP,atomlist0):
        tmpIS = []
        tmpFS = []
        for iatom in atomlist0:
        ...
        for index in tmpIS:
            string = string +str(index)
        self.ECFP0name = string

        return

    def GenNamewithsite(self,ISECFP,FSECFP,atomlist0):
        tmpIS = []
        tmpFS = []
        for iatom in atomlist0:
            tmpIS.append(hashlist(['IS',ISECFP.genbylayer[1][iatom].index]))
        ...
        self.ECFP_withsite = tmpIS

        string = ''
        for index in tmpIS:
            string = string +str(index)
        self.ECFPname_withsite = string
